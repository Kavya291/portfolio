...
const Navbar = () => {
  ...
  // Base style for both Logo and Links to ensure consistency
  const linkStyle = {
    fontFamily: 'var(--font-mono)',
    textDecoration: 'none',
    cursor: 'pointer',
    fontSize: '14px',
    color: 'var(--light-slate)', // Standard link color
  ...
  return (
    <nav className="nav-container" style={{
      ...
      alignItems: 'center',
      // Padding and height are now handled by CSS class for responsiveness
    }}>
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: '40px', flexWrap: 'wrap', justifyContent: 'center' }}>
        ...
        {/* Nav Links (No Numbers, Same Font) */}
      ...
      <div className="social-icons" style={{ display: 'flex', gap: '25px', alignItems: 'center' }}>
        ...
        {/* Changed default mail link to open Gmail Compose */}
